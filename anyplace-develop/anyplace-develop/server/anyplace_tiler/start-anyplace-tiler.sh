...
cd "/cygdrive/c/Work/Project/HSM/Anyplace_Develop/anyplace-develop/anyplace-develop/server/"
...
get_abs_path2(){
    ...
    echo "abhishek in get_abs_path2" >> abhisheklog.txt
    echo "arguement passed" >> abhisheklog.txt
    echo "$1" >> abhisheklog.txt
    echo "output" >> abhisheklog.txt
	echo "$arg_path" >> abhisheklog.txt
...
echo "Log: $LOG"
#echo "End of start-anyplace-tiler.sh .. Press any key to continue"
#read 