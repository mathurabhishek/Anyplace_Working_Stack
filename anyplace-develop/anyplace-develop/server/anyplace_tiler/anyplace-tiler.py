...
def getImageInfoFromFile(filename):
    print("abhishek getImageInfoFromFile")
    f = open(filename, 'rb')
...
def getImageInfoFromFile2(filename):
    ...
    print("printing path")
    print(path)
    print("abhishek getImageInfoFromFile2")
    print(path)
    #path="C:/Work/Project/HSM/Anyplace_Develop/anyplace-develop/anyplace-develop/server/floor_plans/building_ad5290a0-4ab8-46db-9b2e-29f51e2b343f_151331883815/fl_2/fl_2"
...
def convertPaddedImage( filename, newW, newH, outputName ):
    path = filename
    print("abhishek convertPaddedImage")
    #print(path)
    #print(outputName)
    #outputName = "C:/work/project/HSM/Anyplace_Develop/anyplace-develop/anyplace-develop/server/floor_plans/building_92eade54-d719-4ab8-a7a2-e46589033b41_1513583949827/fl_4/padded-image.png"
    ...
    print("convert executed successfully!")


def resizeImage( srcImage, zoomOriginal, zoomCurrent, destImage ):
    print("abhishek resizeImage")
    #print(srcImage)
    #print(destImage)
    #destImage = "C:/Work/Project/HSM/Anyplace_Develop/anyplace-develop/anyplace-develop/server/floor_plans/building_92eade54-d719-4ab8-a7a2-e46589033b41_1513583949827/fl_4/zoom-sized-image-z20.png"
...
def googleTileCutter( googleTilerScript, zoom, tileCoords, imageFile ):
    print("abhishek googleTileCutter")
    print(imageFile)
    print(googleTilerScript)
    #imageFile = "C:/work/project/HSM/Anyplace_Develop/anyplace-develop/anyplace-develop/server/floor_plans/building_92eade54-d719-4ab8-a7a2-e46589033b41_1513583949827/fl_4/padded-image.png"
    ...
    print("le lo")
    print(googleTilerScript, '-o', str(zoom), '-t', ('%d,%d' % (tileCoords.x, tileCoords.y)), '-z', str(zoom), imageFile)

def fixTileStructure( fixTileStructureScript, ImageFileName ):
    print(fixTileStructureScript)
    print(ImageFileName)
...
def main( argv ):
    ...
    print("path dekh le")
    print(os.path.dirname(os.path.realpath(ImageFileName)))
    print(os.path.realpath(ImageFileName))
    ...
    for currentZoom in range( OriginalZoom, (ToZoom-1), -1 ):
        ...
        print("cutting done if sequential")
